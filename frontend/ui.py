...
def main():
    ...
    if st.button("Ask Meditrain"):
        if user_query:
            ...
            try:
                ...
                response = requests.post("https://meditrainai-26.onrender.com/response", json=payload)
                if response.status_code == 200:
    ...
    for chat in st.session_state["conversation"]:
        ...
        with cols[0]:
            ...
            if user_avatar:
                st.image(user_avatar, use_container_width=False)
        with cols[1]:
        ...
        with cols[0]:
            ...
            if bot_avatar:
                st.image(bot_avatar, use_container_width=False)
        with cols[1]:
